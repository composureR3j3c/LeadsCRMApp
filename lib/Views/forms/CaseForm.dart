...
class _CaseFormState extends State<CaseForm> {
  ...
  Future submitFollowup() async {
    var res = await OnPremMethods.createFollowUp(firstName, lastName,
        organisation, finalPhone, subject, street, city, country, description);
